			...
			<section className={style.section}>
				<div className={style.area}>
					<div className={style.top_text}>
						...
						<p>
							Join our League of Legends course to level up your gaming skills
							and be trained like a professional player under the expert
							guidance of former LCS coach DanDan
						</p>
					</div>
					<div className={style.video}>
						<div className={style.video_top}>
